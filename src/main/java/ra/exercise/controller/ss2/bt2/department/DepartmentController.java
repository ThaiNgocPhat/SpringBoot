package ra.exercise.controller.ss2.bt2.department;
...
@Controller
@RequestMapping("/ss2/baitap2/department")
public class DepartmentController {
    ...
    public String saveDepartment(@ModelAttribute("department") Department department) {
        ...
        return "redirect:/ss2/baitap2/department";
    }
    ...
    public String showEditForm(@PathVariable("id") Integer id, Model model) {
        ...
        return "redirect:/ss2/baitap2/department"; // Nếu không tìm thấy, quay lại danh sách
    }
    ...
    public String updateDepartment(@PathVariable("id") Integer id, @ModelAttribute("department") Department department) {
        departmentService.save(department);
        return "redirect:/ss2/baitap2/department"; // Sau khi cập nhật, quay lại danh sách
    }
    ...
    public String changeStatus(@PathVariable("id") Integer id) {
        ...
        return "redirect:/ss2/baitap2/department"; // Sau khi thay đổi, quay lại danh sách
    }
    ...
    public String deleteDepartment(@PathVariable("id") Integer id) {
        ...
        return "redirect:/ss2/baitap2/department"; // Sau khi xóa, quay lại danh sách
    }
}
